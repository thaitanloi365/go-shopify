...
```console
$ go get github.com/thaitanloi365/go-shopify
```

## Use

```go
import "github.com/thaitanloi365/go-shopify"
```
...
pass in the built in options or create your own and manipulate the client. See [options.go](https://github.com/thaitanloi365/go-shopify/blob/master/options.go)
for more details.
